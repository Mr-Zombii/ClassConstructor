package com.github.puzzle.cc.writer.field;
...
public class FieldWriter {
    ...
    public FieldWriter(ClassWriter writer, FieldInfo info) {
    ...
    public FieldWriter(String name, String descriptor) {
        this.name = name;
        this.descriptor = descriptor;
    }

    public FieldWriter(String name, Class<?> type) {
        this(name, type.descriptorString());
    }
