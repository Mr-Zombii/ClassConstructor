...
public class Opcodes {
    ...
    public static final int IFNONNULL = 0x199;
    ...
    public static final Map<String, Integer> STR_TO_INT = new HashMap<>();
    public static final Map<Integer, String> INT_TO_STR = new HashMap<>();

    static {
        for (Field field : Opcodes.class.getFields()) {
            if (field.getType().equals(int.class)) {
                try {
                    STR_TO_INT.put(field.getName(), (Integer) field.get(null));
                    INT_TO_STR.put((Integer) field.get(null), field.getName());
